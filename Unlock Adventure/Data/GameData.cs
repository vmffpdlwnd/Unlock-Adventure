...
namespace UnlockAdventure.Data
{
    ...
    {
        private static Dictionary<string, Dictionary<TextManager.Language, string>> textData;
        private static Dictionary<string, Dictionary<TextManager.Language, string>> achieveData;
        ...
        {
            textData = new Dictionary<string, Dictionary<TextManager.Language, string>>();
        ...
        private static void Add(string key, string kr, string en, Dictionary<string, Dictionary<TextManager.Language, string>> target = null)
        {
            ...
            target[key] = new Dictionary<TextManager.Language, string>
            {
                [TextManager.Language.Korean] = kr,
                [TextManager.Language.English] = en
            };
        }

        public static string GetText(string key, TextManager.Language lang)
        {
        ...
        public static string GetAchieve(string key, TextManager.Language lang)
        {
